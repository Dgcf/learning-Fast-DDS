    ...
    namespace fastdds
    {
        namespace dds
        {
            ...
            PublisherImpl::PublisherImpl(
                ...
                : participant_(p), qos_(&qos == &PUBLISHER_QOS_DEFAULT ? participant_->get_default_publisher_qos() : qos), listener_(listen), publisher_listener_(this), user_publisher_(nullptr), rtps_participant_(p->get_rtps_participant()), default_datawriter_qos_(DATAWRITER_QOS_DEFAULT)
            {
                ...
                const PublisherQos &qos)
            {
                ...
                const PublisherQos &qos_to_set = (&qos == &PUBLISHER_QOS_DEFAULT) ? participant_->get_default_publisher_qos() : qos;
